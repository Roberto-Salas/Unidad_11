package seccion_9_1;
 ...
 // Fig. 11.17: MarcoCasillaVeriﬁcacion.java
 ...
 public class MarcoCasillaVerificacion extends JFrame
 {
     ...
     public MarcoCasillaVerificacion()
     {
        ...
        negritaJCheckBox = new JCheckBox( "Negrita" ); // crea casilla de veriﬁcación "negrita"
        cursivaJCheckBox = new JCheckBox( "Cursiva" ); // crea casilla de veriﬁcación "cursiva"
        add( negritaJCheckBox ); // agrega casilla de veriﬁcación "negrita" a JFrame
        add( cursivaJCheckBox ); // agrega casilla de veriﬁcación "cursiva" a JFrame
    ...
    } // ﬁn del constructor de MarcoCasillaVeriﬁcacion
    ...
    private class ManejadorCheckBox implements ItemListener
    {
        ...
        {
            // procesa los eventos de la casilla de veriﬁcación "negrita"
        ...
        } // ﬁn de la clase interna privada ManejadorCheckBox
    } // ﬁn de la clase MarcoCasillaVeriﬁcacion